...
export default {
  ...
  app: {
    contacts: {
      ...
      contactsList: {
        error: {
          ...
          description:
            'Пожалуйста, проверьте соединение с сервером и попробуйте ещё раз.',
          retryBtnTitle: 'Попробовать ещё раз',
        },
      },
    },
    updateLanguage: {
    ...
    search: {
      ...
      modalBioPlaceholder: 'Этот пользователь не заполнил описание профиля.',
    },
    params: {
      link: 'Параметры',
      location: {
        title: 'География',
        description: 'Искать пользователей, находящихся..',
        local: 'В моём городе',
      },
      error: {
        title: 'Мы не получили ответа от сервера.',
        description:
          'Пожалуйста, проверьте подключение к интернету и свайпните вниз для повторного запроса.',
      },
      noResult: {
        title: 'Совсем никого!',
        description:
          'В нашей базе не нашлось пользователей, подходящих под заданные параметры. Вы можете изменить параметры поиска.',
        btnTitle: 'Открыть параметры поиска',
      },
    },
  },
  register: {
